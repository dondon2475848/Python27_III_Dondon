...
def lillianLinkToNewBlog(urlIn):
    ...
    res.encoding='utf-8'
    soup=bs(res.text,'lxml')
    return soup.select('#article-content-inner a')[0].get('href')
# 創立資料夾
def mkdir(path):
...
def main():
    ...
    with open('./data/blogListNeedDealWith.json','r') as f:
        moveBlogDic=json.load(f);
    #print len(movelist)
    with open('./data/ifoodieBlogDic20160616Author_id_Article.json','r') as f:
        ifBlogDic=json.load(f);
    #print len(ifBlogDic)
    count=0
    for ifb in ifBlogDic.values():
        if ifb['_id'] in moveBlogDic.keys():
            count+=1
            #print 'get'
            #print ifb['url']
            print count
            ArticleContent=GetArticle(lillianLinkToNewBlog(ifb['url']))
            print ArticleContent,',\n文章字數為：',len(ArticleContent)
            ifb['article']=ArticleContent
    with open('./data/ifoodieBlogDic20160619Update5Pixnet.json','w') as f:
        json.dump(ifBlogDic,f)
            
            
        
    
    
#     for b in moveBlogDic.keys()[0:3]:
#         print b
    
#     url = 'http://americangod.pixnet.net/blog/post/55444863-%5b%e5%8f%b0%e5%8c%97%e9%a3%9f%e8%a8%98%5d-nash-%e5%90%83-%e6%96%87%e6%85%b6%e9%9b%9e-%e6%b5%b7%e5%8d%97%e9%9b%9e%e9%a3%af'
#     url = 'http://sharonwhite.pixnet.net/blog/post/31380581'
#     url = 'http://banbi217.pixnet.net/blog/post/181840329'
#     url = 'http://lillian1101.pixnet.net/blog/post/280421818-%e5%8f%b0%e5%8c%97%e9%9f%93%e5%bc%8f%7c%e6%9d%b1%e5%8d%80%e5%b8%82%e6%b0%91%e5%a4%a7%e9%81%93%e7%be%8e%e9%a3%9f-the-owl%e6%95%96%e5%94%b7%e9%9f%93%e5%bc%8f%e6%b9%af'
#     url = 'http://elvagwan3.pixnet.net/blog/post/85887770'
#     
#     print lillianLinkToNewBlog(url)
#     ArticleContent=GetArticle(lillianLinkToNewBlog(url))
#     print ArticleContent,',\n文章字數為：',len(ArticleContent)

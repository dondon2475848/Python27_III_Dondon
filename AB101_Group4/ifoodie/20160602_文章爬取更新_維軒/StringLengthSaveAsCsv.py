...
def createLog(listIndex,blog_id,blog_url,ExceptType):
    with open('./data/blog/article/log/ArticleLenLess100_1_%s_%s.txt' %(date,ExceptType) , 'a') as f:
        f.write(str(listIndex)+','+blog_id+','+blog_url+'\n')
def main():
    with open('./data/blog/article/listMerge_72838_22056_22099_v7.json','r') as f:
    ...
    with open('./Excel/ArticleLenLess100_Report.csv','wb') as f:
        w = csv.writer(f)
